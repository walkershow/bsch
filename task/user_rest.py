...
from task_profiles_rest import TaskProfile_Rest
sys.path.append("..")
import dbutil
import utils
...
class UserAllot(object):
    ...
    def __init__(self, server_id, pc, db, logger):
        ...
        self.logger = logger
        self.task_profile = TaskProfile_Rest(server_id, db, pc, logger)
...
def test():
    ...
    user_allot = UserAllot_Rest(15, pc, dbutil, logger)
