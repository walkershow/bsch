...
local db = config.mysql_vm3_connect()
...
local sql = string.format("select a.cur_profile_id,b.name,b.shortcut from vm_cur_task a,profiles b where a.cur_profile_id=b.id and a.server_id=%d and a.vm_id=%d and a.status in (-1,1)", serverid, vmid)
